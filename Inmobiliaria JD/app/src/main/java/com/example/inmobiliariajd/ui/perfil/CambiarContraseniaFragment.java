...
import com.example.inmobiliariajd.databinding.FragmentCambiarContraseniaBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding.btnGuardarContrasenia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String passActual = binding.etContraseniaActual.getText().toString();
                String passNueva = binding.etContraseniaNueva.getText().toString();
