...
public class CargarInmueblesViewModel extends AndroidViewModel {
    private MutableLiveData<Uri> mUri = new MutableLiveData<>();
    private MutableLiveData<String> mError = new MutableLiveData<>();

    public CargarInmueblesViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void cargarInmueble(String direccion, String uso, String ambientes, String superficie, String tipo,String precio, boolean disponible){
        int superficieInt = 0;
        int ambientesInt = 0;
        double precioD = 0;
        try {
